...
export default function AdminDashboard() {
  ...
  const stats = [{ label: 'پروژه‌ها', value: projects.length, icon: FolderPlus, color: 'text-sky' }, { label: 'یاقوت', value: totalYaqut, icon: Gem, color: 'text-ruby' }, { label: 'شرکت‌کنندگان', value: totalMembers, icon: BarChart3, color: 'text-beige' }, { label: 'میانگین', value: projects.length > 0 ? Math.round(totalYaqut / projects.length) : 0, icon: TrendingUp, color: 'text-ruby-glow' }];
