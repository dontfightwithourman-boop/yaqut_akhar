...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return <div className="min-h-screen bg-cream dark:bg-gradient-to-br dark:from-navy-dark dark:via-navy dark:to-navy-dark"><Navbar /><div className="flex pt-16"><Sidebar /><main className="flex-1 p-4 sm:p-6 min-h-[calc(100vh-4rem)]">{children}</main></div></div>;
}
