...
export interface WorkshopLoan { id: string; loan_number: number; item_id: string; item_name: string; quantity: number; group_number: string; borrower_name: string; phone_number: string; borrow_date: string; return_date: string; status: string; created_at: string; }
