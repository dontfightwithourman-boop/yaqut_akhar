...
export const workshopAPI = {
  ...
  createLoan: (data: { item_id: string; item_name: string; quantity?: number; group_number?: string; borrower_name?: string; phone_number?: string; borrow_date: string; return_date: string }) => request<{ loan: WorkshopLoan }>('/workshop/loans', { method: 'POST', body: JSON.stringify(data) }),
